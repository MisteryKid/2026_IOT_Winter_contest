...
---
> ** Project Status: PoC (Proof of Concept)**
> 본 프로젝트는 '제 1회 사물인터넷 플랫폼 활용 개발자 챌린지' 출품작으로, **oneM2M 표준 플랫폼 기반의 안전 시스템 로직 검증**을 위해 제작된 프로토타입입니다. 제한된 개발 기간(2주) 및 하드웨어 환경을 고려하여 범용 센서로 구현되었습니다.
